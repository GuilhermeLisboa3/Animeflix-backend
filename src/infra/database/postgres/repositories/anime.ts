import { CheckAnime, CreateAnime, LoadAnimeById } from '@/domain/contracts/database/anime'
import { Anime } from '@/infra/database/postgres/entities'

export class AnimeRepository implements CheckAnime, CreateAnime, LoadAnimeById {
