import { makeSignUpController, makeLoginController, makeUpdateAccountController, makeUpdatePasswordController, makeGetAccountDataController } from '@/main/factories/application/controllers/account'
