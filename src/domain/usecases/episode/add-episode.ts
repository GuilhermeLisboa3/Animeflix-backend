...
type Setup = (animeRepository: CheckAnimeById, episodeRepository: CheckEpisodeByOrder & CreateEpisode, uuid: UUIDGenerator, fileStorage: UploadFile & DeleteFile) => AddEpisode
