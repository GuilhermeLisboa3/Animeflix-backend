...
type Setup = (animeRepository: CheckAnimeById, episodeRepository: CheckEpisodeByOrder, uuid: UUIDGenerator) => AddEpisode
...
export const AddEpisodeUseCase: Setup = (animeRepository, episodeRepository, uuid) => async ({ animeId, order, file, name, synopsis, secondsLong }) => {
